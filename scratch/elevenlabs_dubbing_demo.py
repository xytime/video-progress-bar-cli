...
SOURCE_FILE = "output/XcSdPK5Xwbk.mp4"
OUTPUT_FILE = "output/XcSdPK5Xwbk_dubbed_zh.mp4"

def run_dubbing_demo():
    print(f"=== ElevenLabs AI Dubbing API Demo ===")
    ...
    data = {
        "target_lang": "zh",
        "source_lang": "en",
        "name": "Denzel_Washington_Positivity_Dub",
        "num_speakers": 1,
        "watermark": True
    }
    ...
    while True:
        try:
            ...
            if status == "dubbed":
                ...
                return
            elif status == "processing" or status == "nearing_completion":
                pass
            else:
