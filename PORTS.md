...
| --- | --- | --- | --- |
| 1.3.0 | 2026-09-08 | Codex | 仪表盘改为可绑定局域网 IPv4；浏览器请求保持同源校验。 |
...
| `9100` | **Video-precessing** | Pipeline 仪表盘（局域网可访问） | `./vpanel ui start`（端口可经 `DASHBOARD_PORT` 覆盖；默认绑定 `0.0.0.0`，浏览器请求必须与当前访问地址同源） |
