...
echo "Downloading Video 3: Eric Schmidt..."
yt-dlp --no-check-certificate --cookies-from-browser chrome -f "bestvideo[height<=720][ext=mp4]+bestaudio[ext=m4a]/best[ext=mp4]/best" "https://youtu.be/tNH43a1EI7s" -o "Schmidt_Speech.%(ext)s"

# Go back to root to run python script
cd ..
